...
/***************************************************************************
 TraceQGIS
                                 A QGIS plugin
 Trace QGIS pour QGIS permet de visualiser et animer des entités géographiques en fonction de plans et d’actions définis dans des fichiers ou scénarios exprimés via le PDDL (Planning Domain Definition Language).
