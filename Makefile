...
SOURCES = \
	__init__.py \
	trace_qgis.py trace_qgis_dialog.py

PLUGINNAME = trace_qgis

PY_FILES = \
	__init__.py \
	trace_qgis.py trace_qgis_dialog.py

UI_FILES = trace_qgis_dialog_base.ui
...
QGISDIR=C:\Users\domin\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
